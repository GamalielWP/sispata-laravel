...
<div class="card">
    <div class="card-body">
        <form action="/dosen-pembimbing-2-update/{{$mhs->user_id}}" method="POST">
            @csrf
            @method('PATCH')
                    ...
                    <div class="collapse" id="score-collapse">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <input name="Ide" class="form-control mb-3" type="number" min="0" max="20" value="{{$sempro->adviser2_score !=null ? $score->ide : '0'}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <label for="Solusi" class="form-label">Teknik Solusi</label>
                                <input name="Solusi" class="form-control mb-3" type="number" min="0" max="20" value="{{$sempro->adviser2_score !=null ? $score->solusi : '0'}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <label for="Analisa" class="form-label">Analisa dan Penarikan simpulan</label>
                                <input name="Analisa" class="form-control mb-3" type="number" min="0" max="20" value="{{$sempro->adviser2_score !=null ? $score->analisa : '0'}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <label for="Penulisan" class="form-label">Tata Tulis Proposal</label>
                                <input name="Penulisan" class="form-control mb-3" type="number" min="0" max="20" value="{{$sempro->adviser2_score !=null ? $score->penulisan : '0'}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group ">
                                <label for="Kemandirian" class="form-label">Kemandirian</label>
                                <input name="Kemandirian" class="form-control mb-3" type="number" min="0" max="20" value="{{$sempro->adviser2_score !=null ? $score->kemandirian_presentasi : '0'}}">
                            </div>
                        </div>
                    </div>
                </div>
